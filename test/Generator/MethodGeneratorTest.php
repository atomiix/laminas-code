...
class MethodGeneratorTest extends TestCase
{
    ...
    public function testSetMethodParameters()
    {
        ...
        $sorting = array_map(static function(ParameterGenerator $parameter): string { return $parameter->getName(); }, $params);
...
PHP;
    ...
    public function returnTypeHintClasses()
    {
        ...
        return array_values(array_filter(
            $parameters,
            static function(array $parameter) { return PHP_VERSION_ID >= 80000
